...
public class Answer {
	...
	{
			if(question.equals("1 Overall Rating (1/2/3/4/5)-Single Select")==true) //if question is equal to 1st question
			{
			token=value.split(" ");
			...
			else if(question.equals("2 Area of improvement (Service Quality/ Communication/ Delivery Process)-Multiple Select Seperated by \" / \"")==true)
			{
				token=value.split(" / ");
